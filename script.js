...
// Eu coloco aspas simples e quando salvo o VS Code coloca aspas duplas e ponto-vírgula.
...
setInterval(() => {
    ...
    const {tRex, horizon, currentSpeed, distanceRan, dimensions}
    ...
    s.type = 'module';
    s.src = 'http://localhost:5550/script.js'
